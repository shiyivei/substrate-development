...
pub mod pallet {
	...
	use pallet_provide_pallet::traits::StorageInterface; //引入外部的pallet中的trait,和使用本pallet自定义的trait一样
	...
	pub trait Config: frame_system::Config {
		...
		type MyStorage: StorageInterface<Value = Self::Value>; //定义关联类型，这里要求实现了StorageInterface的trait
	}
